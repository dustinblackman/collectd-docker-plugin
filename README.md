...
```bash
curl -Ls "https://github.com/dustinblackman/collectd-docker-plugin/releases/download/0.1.1/collectd-docker-plugin-linux-amd64-0.1.1.tar.gz" | tar xz -C /usr/local/bin/
